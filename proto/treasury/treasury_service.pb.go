...
const file_services_treasury_services_treasury_service_proto_treasury_service_proto_rawDesc = "" +
	...
	"isOptional2R\n" +
	"\bManifest\x12F\n" +
	"\vGetManifest\x12\x19.treasury.ManifestRequest\x1a\x1a.treasury.ManifestResponse\"\x00B)Z'example.com/go-mono-repo/proto/treasuryb\x06proto3"
...
var file_services_treasury_services_treasury_service_proto_treasury_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_services_treasury_services_treasury_service_proto_treasury_service_proto_goTypes = []any{
	(*ManifestRequest)(nil),     // 0: treasury.ManifestRequest
	(*ManifestResponse)(nil),    // 1: treasury.ManifestResponse
	(*ServiceIdentity)(nil),     // 2: treasury.ServiceIdentity
	(*BuildInfo)(nil),           // 3: treasury.BuildInfo
	(*RuntimeInfo)(nil),         // 4: treasury.RuntimeInfo
	(*ServiceMetadata)(nil),     // 5: treasury.ServiceMetadata
	(*ServiceCapabilities)(nil), // 6: treasury.ServiceCapabilities
	(*ServiceDependency)(nil),   // 7: treasury.ServiceDependency
	nil,                         // 8: treasury.ServiceMetadata.LabelsEntry
}
var file_services_treasury_services_treasury_service_proto_treasury_service_proto_depIdxs = []int32{
	2, // 0: treasury.ManifestResponse.identity:type_name -> treasury.ServiceIdentity
	3, // 1: treasury.ManifestResponse.build_info:type_name -> treasury.BuildInfo
	4, // 2: treasury.ManifestResponse.runtime_info:type_name -> treasury.RuntimeInfo
	5, // 3: treasury.ManifestResponse.metadata:type_name -> treasury.ServiceMetadata
	6, // 4: treasury.ManifestResponse.capabilities:type_name -> treasury.ServiceCapabilities
	8, // 5: treasury.ServiceMetadata.labels:type_name -> treasury.ServiceMetadata.LabelsEntry
	7, // 6: treasury.ServiceCapabilities.dependencies:type_name -> treasury.ServiceDependency
	0, // 7: treasury.Manifest.GetManifest:input_type -> treasury.ManifestRequest
	1, // 8: treasury.Manifest.GetManifest:output_type -> treasury.ManifestResponse
